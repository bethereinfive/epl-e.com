<template>
    ...
    <form @submit.stop.prevent="onSubmit" class="mt-5">
    <!-- <main class="mx-3">
...
আপনার একাউন্টে যত টাকা থাকবে তারউপর কমিশন পাবেন প্রতিদিন।<br/><br/>

আপনার আমানত যে কোন সময় তুলতে পারবেন বিকাশ/নগদ/রকেট ও USD এর মাধ্যমে। ধন্যবাদ <br/><br/>
