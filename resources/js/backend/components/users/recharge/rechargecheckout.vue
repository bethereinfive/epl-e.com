...
<div data-v-464536f2="" class="fifbutton flex_row_between afz14" style="width: 270px !important;">
    ...
    <button type="button" @click="onSubmit" data-v-464536f2="" style="border: 0 !important;font-size: 13px;width: 50% !important;" class="flexauto onbut">পেমেন্ট নিশ্চিত করুন</button>
</div>
